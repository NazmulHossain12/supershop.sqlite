                    ...
                    <form action="{{ route('admin.purchase-orders.store') }}" method="POST">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700"
                                    ...
                                    <tbody id="items-body" class="divide-y divide-gray-200 dark:divide-gray-700">
                                        <tr class="item-row">
                                            ...
                                            <td class="p-2 vat-amount text-sm font-medium text-gray-500">0.00</td>
                        ...
                        <div class="mt-4 flex flex-col items-end gap-2 pr-12">
                            <div class="text-sm">
                                ...
                                <span id="total-vat" class="font-bold ml-2">0.00</span>
                            </div>
                            <div class="text-lg">
                                <span class="text-gray-700 dark:text-gray-300">Grand Total:</span>
                                <span id="grand-total" class="font-bold ml-2 text-primary-600">0.00</span>
                            </div>
                        </div>
